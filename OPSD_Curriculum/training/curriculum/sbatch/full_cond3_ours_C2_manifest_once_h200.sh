...
#SBATCH --gres=gpu:2
#SBATCH --mem=200G
#SBATCH --job-name opsd_cur_cond3_ours_C2_manifest_once_h200
...
# ============================================================
# Wave-1 ③ ours — manifest_once fair 1-pass OPSD curriculum
# Qwen3-8B, H200 x2, B_glob=32 via pd2*ga8*ws2.
# Uses stages_cond3_ours_C2.json, stage order 0->1->2->3->4,
...
RUN_CONFIG=full_cond3_ours_C2_manifest_once_h200
