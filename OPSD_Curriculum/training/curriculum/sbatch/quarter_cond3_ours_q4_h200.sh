...
#SBATCH --gres=gpu:2
#SBATCH --mem=200G
#SBATCH --job-name opsd_quarter_cond3_ours_q4_h200
...
# ============================================================
# QUARTER ours — manifest_once fair 1-pass OPSD curriculum (1/4 scale)
# Qwen3-8B, H200 x2, B_glob=32 via pd2*ga8*ws2.
# Uses stages_cond3_ours_C2_q4.json, ~7.2k problems, T~225.
...
OURS_JSON=$STAGES_TIERED/stages_cond3_ours_C2_q4.json
RUN_CONFIG=quarter_cond3_ours_q4_h200
