...
#SBATCH --gres=gpu:2
#SBATCH --mem=200G
#SBATCH --job-name opsd_full_cond_diff_subjslack_h200
...
# ============================================================
# full diff — subjslack (level_backbone_residual_subject_slack, alpha=2.0)
...
ARM_JSON=$DIFF_JSON
RUN_CONFIG=full_cond_diff_subjslack_h200
