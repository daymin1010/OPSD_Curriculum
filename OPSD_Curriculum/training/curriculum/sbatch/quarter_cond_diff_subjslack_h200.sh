...
#SBATCH --gres=gpu:2
#SBATCH --mem=200G
#SBATCH --job-name opsd_quarter_cond_diff_subjslack_h200
...
# ============================================================
# quarter diff — subjslack (level_backbone_residual_subject_slack, alpha=2.0)
# Qwen3-8B, H200 x2, B_glob=32 (pd2*ga8*ws2). manifest: q4, arm=diff.
...
ARM_JSON=$DIFF_JSON
RUN_CONFIG=quarter_cond_diff_subjslack_h200
