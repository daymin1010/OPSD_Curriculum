...
#SBATCH --gres=gpu:4
#SBATCH --mem=200G
#SBATCH --job-name opsd_cur_feas_8b_h200
...
# ============================================================
# 8B FEASIBILITY — Qwen3-8B on H200 (141GB) ×4 (ws=4). Headroom baseline /
# fallback if L40S 8B OOMs. B_glob=32 via pd1*ga8*ws4. gpu_mem_util=0.6.
# Short probe T=8 (diff-only). H200 contended -> submit after L40S attempts.
# ============================================================
set -euo pipefail
