...
#SBATCH --gres=gpu:2
#SBATCH --mem=200G
#SBATCH --job-name opsd_mini100_cond_ours_subjslack_h200
...
# ============================================================
# mini100 ours — subjslack (level_backbone_residual_subject_slack, alpha=2.0)
# Qwen3-8B, H200 x2, B_glob=32 (pd2*ga8*ws2). manifest: mini100, arm=ours.
...
ARM_JSON=$OURS_JSON
RUN_CONFIG=mini100_cond_ours_subjslack_h200
