...
#SBATCH --gres=gpu:2
#SBATCH --mem=200G
#SBATCH --job-name opsd_mini100_cond2_diff_h200
...
# Uses stages_cond2_diff_mini100.json (N=3198, T_total~100).
...
RUN_CONFIG=mini100_cond2_diff_h200
