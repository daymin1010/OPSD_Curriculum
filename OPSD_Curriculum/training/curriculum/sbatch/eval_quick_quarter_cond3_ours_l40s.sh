...
#
# EVAL quarter cond3_ours — 5 checkpoints (step 10,50,100,150,220).
...
CKPT_BASE=$REPO/checkpoints/opsd_curriculum/quarter_8b/quarter_cond3_ours_q4_h200
...
run_eval() {
  ...
  echo "=================================================================="
  echo "[$(date +%H:%M:%S)] EVAL quarter_cond3_ours step=$step  dataset=$ds  val_n=$valn  thinking=OFF  TP=2"
  echo "=================================================================="
  ...
  python "$EVAL" \
    ...
    --no_thinking \
    --output_file "$OUTDIR/${ds}_quarter_cond3_ours_step${step}_nonthink_valn${valn}.json"
