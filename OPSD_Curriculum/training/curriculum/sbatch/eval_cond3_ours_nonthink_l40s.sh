...
#SBATCH --mem=200G
#SBATCH --job-name opsd_cur_eval_cond3_nt_l40s
...
# Based on eval_main_l40s.sh + OPSD_original/eval/run_eval_nonthink.sh pattern.
...
OUTDIR=$REPO/outputs/eval_opsd_curriculum/cond3_ours_nonthink
...
for DS in aime24 aime25 hmmt25; do
  echo "=================================================================="
  echo "[$(date +%H:%M:%S)] EVAL cond3_ours  dataset=$DS  val_n=12  temp=1.0  thinking=OFF  TP=2"
  echo "=================================================================="
  python "$EVAL" \
    ...
    --no_thinking \
    --output_file "$OUTDIR/${DS}_cond3_ours_nonthink_valn12.json"
