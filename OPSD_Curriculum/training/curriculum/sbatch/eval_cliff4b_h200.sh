...
#SBATCH --mem=200G
#SBATCH --job-name eval_cliff4b_h200
...
OUTDIR="${OUTDIR:-$REPO/outputs/eval_opsd_curriculum/${RUN_PREFIX:-cliff4b}_${ARM}_nonthink}"
...
for STEP in $STEPS; do
  ...
  for ds_valn in "aime24 12" "aime25 12" "hmmt25 12" "math500 1" "minerva 1"; do
    ...
    OUT="$OUTDIR/${ds}_${RUN_PREFIX:-cliff4b}_${ARM}_step${STEP}_nonthink_valn${valn}.json"
