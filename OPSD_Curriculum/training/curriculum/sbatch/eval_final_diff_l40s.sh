...
#
# EVAL final checkpoints — cond2_diff (diff): mini50-step50, mini100-step100, q4-step225
...
run_eval "$REPO/checkpoints/opsd_curriculum/mini50_8b/mini50_cond2_diff_h200/checkpoint-50" \
  "mini50_diff_step50" \
  "$REPO/outputs/eval_opsd_curriculum/mini50_cond2_diff_nonthink"

# mini100 final (step 100)
run_eval "$REPO/checkpoints/opsd_curriculum/mini100_8b/mini100_cond2_diff_h200/checkpoint-100" \
  "mini100_diff_step100" \
  "$REPO/outputs/eval_opsd_curriculum/mini100_cond2_diff_nonthink"

# q4 final (step 225)
run_eval "$REPO/checkpoints/opsd_curriculum/quarter_8b/quarter_cond2_diff_q4_h200/checkpoint-225" \
  "q4_diff_step225" \
  "$REPO/outputs/eval_opsd_curriculum/quarter_cond2_diff_nonthink"

echo "ALL FINAL EVAL DONE (diff)"
