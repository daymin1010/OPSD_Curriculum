...
#
# q4 diff step-curve — checkpoints 130(s2끝), 180(s3끝). TP=2, non-thinking.
# AIME24/25/HMMT25 (val_n=3) + MATH500 (val_n=1). 기존 step225 final과 합쳐 H2.
