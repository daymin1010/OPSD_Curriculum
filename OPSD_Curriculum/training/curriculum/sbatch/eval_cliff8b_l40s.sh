...
#   사용: sbatch --job-name eval_cliff8b_<ARM> eval_cliff4b_l40s.sh <ARM> ["100 400 650 900"]
...
CKPT_BASE="${CKPT_BASE:-$REPO/checkpoints/opsd_curriculum/full_8b/cliff8b_${ARM}}"
...
OUTDIR="${OUTDIR:-$REPO/outputs/eval_opsd_curriculum/cliff8b_${ARM}_nonthink}"
...
for STEP in $STEPS; do
  ...
  for ds_valn in "aime24 12" "aime25 12" "hmmt25 12" "math500 1" "minerva 1"; do
    ...
    OUT="$OUTDIR/${ds}_cliff8b_${ARM}_step${STEP}_nonthink_valn${valn}.json"
