...
#SBATCH --mem=200G
#SBATCH --job-name opsd_cur_eval_main_hmmt25
...
#
# EVAL ③-A (main) HMMT25-only — Qwen3-8B + LoRA(r=64) on L40S (48GB) x2 (TP=2).
# Uses OPSD canonical eval harness (opsd_src/eval/evaluate_math.py).
# thinking ON (default), val_n=12 (Avg@12), temp=1.0, dataset: hmmt25.
