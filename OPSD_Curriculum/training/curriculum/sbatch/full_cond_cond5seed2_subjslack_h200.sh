...
#SBATCH --gres=gpu:2
#SBATCH --mem=200G
#SBATCH --job-name opsd_full_cond5seed2_subjslack_h200
...
# ============================================================
# full cond5 (diffmatched, seed2) — subjslack control.
# Qwen3-8B, H200 x2, B_glob=32 (pd2*ga8*ws2). T~900. arm=cond5_seed2.
...
COND5_JSON=$STAGES/stages_cond5_diffmatched_seed2.json
ARM_JSON=$COND5_JSON
RUN_CONFIG=full_cond_cond5seed2_subjslack_h200
