...
#SBATCH --mem=200G
#SBATCH --job-name eval_think4b_h200
...
#   사용: sbatch --job-name think4b_<ARM> eval_think4b_h200.sh <ARM> ["900"]
...
CKPT_BASE="${CKPT_BASE:-$REPO/checkpoints/opsd_curriculum/full_4b_cliff/${RUN_PREFIX:-cliff4b}_${ARM}}"
...
OUTDIR="${OUTDIR:-$REPO/outputs/eval_opsd_curriculum/${RUN_PREFIX:-cliff4b}_${ARM}_think}"
...
for STEP in $STEPS; do
  ...
  for ds_valn in "aime24 12" "aime25 12" "hmmt25 12"; do
    ...
    OUT="$OUTDIR/${ds}_${RUN_PREFIX:-cliff4b}_${ARM}_step${STEP}_think_valn${valn}.json"
