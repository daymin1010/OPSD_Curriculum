...
#SBATCH --gres=gpu:2
#SBATCH --mem=200G
#SBATCH --job-name opsd_mini50_cond2_diff_h200
...
# ============================================================
# MINI50 diff — manifest_once fair 1-pass OPSD curriculum (~1/4.5 of q4).
# Qwen3-8B, H200 x2, B_glob=32 via pd2*ga8*ws2.
# Uses stages_cond2_diff_mini50.json (N=1603, T_total~51).
...
RUN_CONFIG=mini50_cond2_diff_h200
