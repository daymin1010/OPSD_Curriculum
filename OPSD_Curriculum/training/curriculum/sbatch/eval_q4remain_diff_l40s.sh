...
#SBATCH --mem=200G
#SBATCH --job-name eval_q4rem_diff
...
CKPT=$REPO/checkpoints/opsd_curriculum/quarter_8b/quarter_cond2_diff_q4_h200/checkpoint-225
OUTDIR=$REPO/outputs/eval_opsd_curriculum/quarter_cond2_diff_nonthink
LABEL=q4_diff_step225
...
echo "ALL Q4-REMAIN EVAL DONE (diff)"
