...
#SBATCH --mem=100G
#SBATCH --job-name eval_s900_cond5s1
...
CKPT_BASE=$REPO/checkpoints/opsd_curriculum/full_8b_subjslack/full_cond_cond5seed1_subjslack_h200
OUTDIR=$REPO/outputs/eval_opsd_curriculum/full_subjslack_cond_cond5seed1_nonthink
ARM=full_cond5seed1
