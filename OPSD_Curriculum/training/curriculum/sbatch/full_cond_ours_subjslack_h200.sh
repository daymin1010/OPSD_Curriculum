...
#SBATCH --gres=gpu:2
#SBATCH --mem=200G
#SBATCH --job-name opsd_full_cond_ours_subjslack_h200
...
# ============================================================
# full ours — subjslack (level_backbone_residual_subject_slack, alpha=2.0)
...
DIFF_JSON=$STAGES/stages_cond2_diff.json
OURS_JSON=$STAGES/stages_cond3_ours_subjslack.json
ARM_JSON=$OURS_JSON
RUN_CONFIG=full_cond_ours_subjslack_h200
