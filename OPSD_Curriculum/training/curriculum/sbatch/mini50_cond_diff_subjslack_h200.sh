...
#SBATCH --gres=gpu:2
#SBATCH --mem=200G
#SBATCH --job-name opsd_mini50_cond_diff_subjslack_h200
...
# ============================================================
# mini50 diff — subjslack (level_backbone_residual_subject_slack, alpha=2.0)
# Qwen3-8B, H200 x2, B_glob=32 (pd2*ga8*ws2). manifest: mini50, arm=diff.
...
ARM_JSON=$DIFF_JSON
RUN_CONFIG=mini50_cond_diff_subjslack_h200
...
"$REPO/envs/opsd/bin/python" -m accelerate.commands.launch \
    ...
    --arm cond_diff_mini50_subjslack \
