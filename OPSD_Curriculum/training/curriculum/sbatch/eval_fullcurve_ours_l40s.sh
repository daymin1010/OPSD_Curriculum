...
#SBATCH --mem=100G
#SBATCH --job-name eval_fullc_ours
...
#
# full subjslack OURS step-curve — checkpoints 100·400·650·900. TP=2, non-thinking.
...
CKPT_BASE=$REPO/checkpoints/opsd_curriculum/full_8b_subjslack/full_cond_ours_subjslack_h200
OUTDIR=$REPO/outputs/eval_opsd_curriculum/full_subjslack_cond_ours_nonthink
ARM=full_ours
STEPS="100 400 650 900"
