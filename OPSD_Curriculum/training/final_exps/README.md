...
## 데이터-분량 격자 통일 (2026-07-14 확정)
- **전체레벨(full) 격자 = 50 / 65 / 80%** (main·cliff·4B·8B 공통; 65%가 관측 정점이라 스케일 비교 기준점)
  - main_d50=14,369(T450) / main_d65=18,699(T585) / main_d80=23,016(T720) — cliff_d50/65/80과 슬롯 정확히 일치(컴퓨트 매칭)
  - ⚠️ `stages_main_d70.json`(n20k=69.6% 근사)은 **전체레벨 격자에서 제외(미사용)** — 8B 큐에서 d65로 교체됨(2026-07-14)
- **L1–5 격자도 50 / 65 / 80%로 통일 (2026-07-14 재확정)**: L5_d50=11,701(T366)/L5_d65=15,222(T476)/L5_d80=18,734(T586). ⚠️ L5_d70(16,391)은 4B에서 이미 실행되어 **보너스 점(70%)으로만 보고**, 격자 비교에는 50/65/80 사용.
