...
#SBATCH --gres=gpu:2
#SBATCH --mem=200G
#SBATCH --job-name cliff4b_mainphase
...
# ============================================================
# Main-phase 학습 (H200, C-03 x2). train_cliff4b_h200.sh 기반.
...
else RUN_CONFIG=${RUN_PREFIX:-cliff4b}_${ARM}; SEED_ARGS=""; fi   # eval 호환: eval_cliff4b_h200.sh <ARM[_s<SEED>]>
