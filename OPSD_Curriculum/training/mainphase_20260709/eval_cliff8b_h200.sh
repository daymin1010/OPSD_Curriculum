...
#SBATCH --mem=200G
#SBATCH --job-name eval_cliff8b_h200
...
CKPT_BASE=$REPO/checkpoints/opsd_curriculum/full_8b/cliff8b_${ARM}
...
OUTDIR=$REPO/outputs/eval_opsd_curriculum/cliff8b_${ARM}_nonthink
